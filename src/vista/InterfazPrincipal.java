...
import java.awt.Font;  // Importa ActionListener para manejar eventos de botones
...
public class InterfazPrincipal extends JFrame {
    ...
    public InterfazPrincipal() {
        ...
        gridBagLayout.columnWidths = new int[]{width/4, width/2, width/4};
        gridBagLayout.rowHeights = new int[]{0, part/2, part/2, 0};
